...
class PIDObject:
    ...
    def update(self, measured: float, update_error: bool = True) -> float:
        ...
        # Firmware-faithful derivative:
        # derivative on measurement instead of error.
        # This avoids derivative kick when the setpoint changes.
        raw_deriv = -(measured - self.prev_measured) / self.dt
        ...
        # Save measured process variable for next derivative update.
